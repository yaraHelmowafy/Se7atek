...
const Pressure = () => {
  ...
  const commentsRef = collection(db, 'Pressure');
  ...
  return (
    <div className="container-dia">
      <div className="cd">
      <br></br><br></br>
        <h3 className="mnd">The Blood Pressure Cases</h3>
      ...
      <main>
        <div className="button-container">
          ...
          <br></br><br></br>
            ...
            {showParagraph && (
              <div>
                <p className="clored-dia2">The Normal range is 120/80</p>
